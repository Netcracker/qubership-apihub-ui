...
import type { PublishedSpecDto } from '../../../src/entities/published-specs'
  ...
  openAPI: {
    ...
    operations: [
      ...
      },
      {
        title: 'Update Pets',
        path: '/v1/pets',
        method: PATCH_METHOD_TYPE,
        tags: ['API v1'],
      },
      {
        title: 'Remove Pets',
        path: '/v1/pets',
        method: DELETE_METHOD_TYPE,
        tags: ['API v1'],
      },
    ],
  },
...
export const MARKDOWN_SPEC: PublishedSpecDto = {
...
export const OPENAPI_3_0_SPEC_RAW = `
{
  ...
  "info": {
    "title": "Petstore",
    "description": "My Petstore API",
    "version": "5.6"
  },
  "externalDocs": {
    "description": "Documentation",
    "url": "https://example.com/PetStore/docs.md"
  },
  "servers": [
    {
      "url": "/",
  ...
  "components": {
    "schemas": {
      ...
      "Pet": {
        "type": "object",
        "description": "Some entity describes a pet",
        "required": ["id"],
        "properties": {
          "id": {
            "type": "string",
