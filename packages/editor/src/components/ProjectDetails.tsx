    ...
    return (
      <Box marginTop={2} height="100%" overflow="hidden">
        <Grid item xs container spacing={2} height="100%" overflow="auto">
          <Grid item xs={6}>
            <TitledValue title="Project name" value={name} />
          </Grid>
          <Grid item xs={6}>
            <TitledValue title="Default Branch" value={defaultBranch} />
          </Grid>
          <Grid item xs={6}>
          ...
          <Grid item xs={12}>
            <TitledValue title="Default Folder" value={defaultFolder} />
          </Grid>
          <Grid item xs={12}>
            <TitledValue title="Repository" value={<Link href={repositoryUrl}>{repositoryName}</Link>} />
          </Grid>
          <Grid item xs={12}>
