      ...
      <BodyCard
        ...
        action={
          <Box sx={{ display: 'flex', gap: 2 }}>
            <Button variant="contained" onClick={handleSaveRolesOrder} disabled={!isChanged} sx={{ width: '100px' }}>
              Save
            </Button>
            <Button variant="outlined" onClick={handleCansel} disabled={!isChanged} sx={{ width: '100px' }}>
              Cancel
            </Button>
          </Box>
        }
