...
export const GeneralPackageSettingsTabViewer: FC<PackageSettingsTabProps> = memo<PackageSettingsTabProps>(
  ({ packageObject, isPackageLoading }) => {
    ...
    const hasDeletePackagePermission = useMemo(() => !!permissions?.includes(DELETE_PACKAGE_PERMISSION), [permissions])
              ...
              <Box marginTop="8px" height="100%" overflow="hidden">
                <Grid item xs container spacing={3} height="100%">
                  ...
                  <Grid item xs={12}>
                    ...
                    <Typography variant="body2" data-testid="DescriptionContent">
