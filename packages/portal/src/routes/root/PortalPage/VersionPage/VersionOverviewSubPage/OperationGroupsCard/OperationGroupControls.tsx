...
import { useOperationsExport } from '@apihub/routes/root/PortalPage/VersionPage/VersionOverviewSubPage/OperationGroupsCard/useOperationsExport'
...
export const OperationGroupControls: FC<OperationGroupControlsProps> = memo<OperationGroupControlsProps>(
  ({ operationGroup, onEditContent, onEdit, onDelete, onPublish }) => {
    ...
    return (
      <Box display="flex" gap={2}>
        ...
        />
        <Tooltip title={downloadButtonTitle} disableHoverListener={actionMenuOpen}>
          <Box sx={{ display: 'inline' }}>
            <MenuButton
              ...
              icon={<DownloadIcon color={isDownloadButtonDisabled ? DISABLED_BUTTON_COLOR : ENABLED_BUTTON_COLOR} />}
        ...
        <ButtonWithHint
          ...
          disableHint={false}
          hint={
            isPrefixGroup ? `Deletion is not available for the ${GROUP_TYPE_REST_PATH_PREFIX} group` : 'Delete group'
          }
