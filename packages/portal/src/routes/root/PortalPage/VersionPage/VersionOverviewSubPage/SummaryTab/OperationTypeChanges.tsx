...
export const OperationTypeChanges: FC<OperationTypeChangesProps> = memo<OperationTypeChangesProps>(
  ({
    ...
    const affectedOperationCounter = useMemo(
      () => numberOfImpactedOperations ?? DEFAULT_CHANGE_SEVERITY_MAP,
      [numberOfImpactedOperations],
    )
    const internalAudienceCounter = useMemo(() => {
      return (
        apiAudienceTransitions?.find(
    ...
    const unknownAudienceCounter = useMemo(() => {
      return (
        apiAudienceTransitions?.reduce((counter, { previousAudience, currentAudience, operationsCount }) => {
          if (
      ...
      <Box mt={4} data-testid={`ValidationsContent-${apiType}`}>
        <Box display="flex">
          ...
          >
            ...
            <Typography sx={{ gridArea: 'noBwcCount' }} variant="body2" data-testid="NumberOfNoBwcOperationsTypography">
              {noBwcOperationsCount}
            </Typography>
            ...
            {internalAudienceOperationsCount !== 0 && (
              <>
                ...
                <Typography sx={{ gridArea: 'internalAudienceCount' }} variant="body2">
                  <Box display="flex">
                    {internalAudienceOperationsCount}
            ...
            {unknownAudienceOperationsCount !== 0 && (
              <>
                ...
                <Typography sx={{ gridArea: 'unknownAudienceCount' }} variant="body2">
                  <Box display="flex">
                    {unknownAudienceOperationsCount}
