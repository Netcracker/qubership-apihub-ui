        ...
        >
          {labels && labels.length !== 0 && (
            <Box sx={blockStyle} data-testid="DocumentLabels">
              {labels.map((label) => (
                <CustomChip key={crypto.randomUUID()} value={label} sx={{ mr: 1 }} />
              ))}
            </Box>
          )}
          <Box sx={blockStyle}>
