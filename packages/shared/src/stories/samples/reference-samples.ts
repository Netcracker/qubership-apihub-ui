...
export const references: PackageReference[] = [
  {
    ...
    parentPackages: ['Primary', 'Secondary', 'APIHUB'],
    key: 'QS.AH',
    latestRevision: true,
  },
  {
    ...
    version: '2023.1@1',
    status: DRAFT_VERSION_STATUS,
    parentPackages: ['Primary', 'Secondary', 'apps', 'Petstore'],
  ...
  },
  {
    ...
    version: 'draft_1@1',
    status: DRAFT_VERSION_STATUS,
    parentPackages: ['Primary', 'Secondary', 'apps', 'Bookstore'],
  ...
  },
  {
    ...
    version: 'test_1@1',
    status: DRAFT_VERSION_STATUS,
    parentPackages: ['Personal sandboxes', 'My Package'],
    key: 'PSB.MYPKG',
    latestRevision: true,
  },
]
