 ...
 */
const combineInheritedExtensions = (inheritedExtensions: OasExtensions): OasExtensions => {
 ...
 */
const mergeCategorizedExtensions = (inherited: OasExtensions, direct: OasExtensions): OasExtensions => {
