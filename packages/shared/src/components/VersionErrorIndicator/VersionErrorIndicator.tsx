...
export type VersionErrorIndicatorProps = UseVersionProblemDetailsParams & TestableProps & {
  tooltip?: ReactNode
...
export const VersionErrorIndicator: FC<VersionErrorIndicatorProps> = memo<VersionErrorIndicatorProps>(({
  ...
  const wrappedContent = <IndicatorRoot>{content}</IndicatorRoot>
