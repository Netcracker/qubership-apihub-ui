...
export const Placeholder: FC<PlaceholderProps> = memo<PlaceholderProps>(
  ({ invisible, variant = DATA_PLACEHOLDER_VARIANT, area, message, children, sx, testId }) => {
    if (invisible) {
      return <>{children}</>
    }
...
type PlaceholderVariant = typeof SEARCH_PLACEHOLDER_VARIANT | typeof DATA_PLACEHOLDER_VARIANT

export const NAVIGATION_PLACEHOLDER_AREA = 'navigation'
export const CONTENT_PLACEHOLDER_AREA = 'content'

type PlaceholderArea = typeof NAVIGATION_PLACEHOLDER_AREA | typeof CONTENT_PLACEHOLDER_AREA
