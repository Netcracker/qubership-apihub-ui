    ...
    const columns: ColumnDef<TableData>[] = useMemo(
      () => [
        ...
        },
        {
          ...
          cell: ({
            row: {
              original: { service, changeSummary },
            },
          }) => {
        ...
        },
        {
          ...
          cell: ({ row: { original, getIsSelected } }) =>
            getIsSelected() && <PromoteVersionDetailsTableCell value={original} />,
        },
        {
          ...
          cell: isSnapshotPublicationInfoSuccess
            ? ({
                row: {
                  original: { service, viewBaselineUrl, serviceConfig },
                },
              }) => {
    ...
    const data: TableData[] = useMemo(
      () =>
        services
          ...
          .map((service) => {
            const { changeSummary, viewBaselineUrl, baselineFound, baselineVersionFound } =
...
const PromoteVersionDetailsTableCell: FC<PromoteVersionDetailsTableCellProps> =
  memo<PromoteVersionDetailsTableCellProps>(({ value: { serviceConfig, builderId } }) => {
