import{n as e}from"./rolldown-runtime-BcKkbAw3.js";import{t}from"./react---BZM-86.js";import{t as n}from"./jsx-runtime--WVWf14b.js";import{n as r,t as i}from"./Box-CzqjOcoU.js";import{n as a,t as o}from"./Typography-B5fOEpx5.js";import{c as s,i as c,n as l,r as u,s as ee,t as d}from"./TableRow-aTq3JYMI.js";import{a as te,i as f,n as p,o as m,r as ne,t as re}from"./TableHead-DJEohbWN.js";import{M as h,N as g,n as _,r as v}from"./iframe-uxV-ecVC.js";import{n as ie,t as y}from"./ButtonWithHint-ENrKaGZf.js";import{a as b}from"./constants-1jyUsruT.js";import{r as x,t as S}from"./components-94kgdBzX.js";import{n as C}from"./arrays-Bfo2Y4Sy.js";import{a as ae,i as oe,t as se}from"./Placeholder-Dh4W-VIJ.js";import{n as ce,t as le}from"./DeleteIcon-BI3SqqhZ.js";import{a as w,c as ue,i as de,l as fe,n as pe,o as me,r as he,s as ge,t as _e}from"./useResizeObserver-DKlKIpxZ.js";import{n as ve,t as T}from"./TextWithOverflowTooltip-p9wzoPFv.js";import{r as E,t as D}from"./tokens-BWzY4ctL.js";import{n as O,t as k}from"./UserView-NZJ4qaqr.js";import{n as A,t as j}from"./FormattedDate-5PJmtqzi.js";import{n as M,t as N}from"./TableCellSkeleton-_ZcECrqT.js";var P,F,I,L,R,z,B,V,H,U,W,G;function K(){return(K=e((()=>{P=t(),s(),m(),c(),f(),p(),l(),a(),me(),ve(),ae(),M(),he(),D(),O(),ie(),ce(),x(),b(),_e(),A(),F=n(),I=(0,P.memo)(({data:e,isLoading:t,deleteApiKey:n,disableDelete:r=!1})=>{let[i,a]=(0,P.useState)(800),[s,c]=(0,P.useState)(),[,l]=(0,P.useState)(),f=(0,P.useRef)(null);pe(f,a);let p=de({containerWidth:i,columnModels:G,columnSizingInfo:s,defaultMinColumnSize:45}),m=(0,P.useMemo)(()=>[{id:z,header:`Name`,cell:({row:{original:{name:e}}})=>(0,F.jsx)(T,{tooltipText:e,children:(0,F.jsx)(o,{variant:`inherit`,children:e})})},{id:B,header:`Roles`,cell:({row:{original:{roles:e}}})=>(0,F.jsx)(T,{tooltipText:e.map(e=>E[e]).join(`, `),children:(0,F.jsx)(o,{variant:`inherit`,children:e.map(e=>E[e]).join(`, `)})})},{id:V,header:`Created At`,cell:({row:{original:{createdAt:e}}})=>(0,F.jsx)(j,{value:e})},{id:H,header:`Created By`,cell:({row:{original:{createdBy:e}}})=>(0,F.jsx)(k,{name:e.name,avatarUrl:e.avatarUrl})},{id:U,header:`Created For`,cell:({row:{original:{createdFor:e}}})=>(0,F.jsx)(k,{name:e.name,avatarUrl:e.avatarUrl})},{id:W,header:``,cell:({row:{original:{key:e,packageKey:t}}})=>(0,F.jsx)(y,{"area-label":`delete`,disabled:r,disableHint:!1,hint:r?`You do not have permission to generate token`:`Delete`,size:`small`,sx:{visibility:`hidden`,height:`20px`},className:`hoverable`,startIcon:(0,F.jsx)(le,{color:`#626D82`}),onClick:()=>n({key:e,packageKey:t}),"data-testid":`DeleteButton`})}],[n,r]),{getHeaderGroups:h,getRowModel:g,setColumnSizing:_}=ge({data:e,columns:m,columnResizeMode:`onChange`,getCoreRowModel:ue(),getExpandedRowModel:fe(),onColumnSizingChange:l,onColumnSizingInfoChange:c});return(0,P.useEffect)(()=>_(p),[_,p]),(0,F.jsxs)(ne,{sx:{mt:1},ref:f,children:[(0,F.jsxs)(ee,{children:[(0,F.jsx)(re,{children:h().map(e=>(0,F.jsx)(d,{children:e.headers.map(e=>(0,F.jsx)(u,{align:`left`,width:p?p[e.id]:e.getSize(),children:w(e.column.columnDef.header,e.getContext())},e.id))},e.id))}),(0,F.jsxs)(te,{children:[g().rows.map(e=>(0,F.jsx)(d,{children:e.getVisibleCells().map(e=>(0,F.jsx)(u,{"data-testid":`Cell-${e.column.id}`,children:w(e.column.columnDef.cell,e.getContext())},e.column.id))})),t&&(0,F.jsx)(L,{})]})]}),C(e)&&!t?(0,F.jsx)(oe,{sx:{width:`inherit`},invisible:t,area:se,message:`No Tokens`}):null]})}),L=(0,P.memo)(()=>S((0,F.jsx)(R,{}),5)),R=(0,P.memo)(()=>(0,F.jsxs)(d,{children:[(0,F.jsx)(N,{}),(0,F.jsx)(N,{}),(0,F.jsx)(N,{}),(0,F.jsx)(N,{}),(0,F.jsx)(N,{}),(0,F.jsx)(N,{})]})),z=`name`,B=`roles`,V=`created-at`,H=`created-by`,U=`created-for`,W=`delete`,G=[{name:z,width:300},{name:B,width:300},{name:V,width:120},{name:H,width:312},{name:U,width:312},{name:W,width:45}],I.__docgenInfo={description:``,methods:[],displayName:`TokensTable`,props:{data:{required:!0,tsType:{name:`Array`,elements:[{name:`signature`,type:`object`,raw:`{
  apiKey?: Key
  key: Key
  packageKey: Key
  name: string
