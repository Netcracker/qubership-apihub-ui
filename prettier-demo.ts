...
function poorlyFormattedFunction(arg1: number, arg2: number): number {
  console.log(
    'Это очень длинная строка, которая определенно превышает установленный лимит в 80 символов, чтобы показать, как Prettier переносит строки кода для лучшей читаемости и соблюдения правил проекта',
  )
...
const add = (a: number, b: number): number => {
  return a + b
} // Нет пробелов вокруг =>, точка с запятой
